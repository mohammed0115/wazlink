...
check("E4 Checkout direct route initializes locally", /function Checkout\(\{ routeMode/.test(checkoutSource) && /useEffect\(/.test(checkoutSource) && /openMockCheckout/.test(checkoutSource));
...
check("F13 service contracts expose typed checkout compatibility", /BillingService/.test(contracts) && /Promise/.test(contracts));
