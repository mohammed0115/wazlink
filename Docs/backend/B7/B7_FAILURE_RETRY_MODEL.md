...
| `CONCURRENCY` | `409 STALE_VERSION` from the target command | conditional — §`B7_CONCURRENCY_MODEL.md` §4 governs whether a bounded re-evaluation is safe; never a blind retry | new |
