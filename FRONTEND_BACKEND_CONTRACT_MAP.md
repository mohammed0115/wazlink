...
| DiscoveryService | local jobs/results | discovery jobs/results | POST/GET `/discovery/jobs` | Job/Result DTO | command | yes | discovery quota | preserve IDs/provenance |
...
| Dashboard read model | composed S5 projection | `/dashboard/overview` | DashboardDTO | read | no | dashboard view | formulas canonical |
